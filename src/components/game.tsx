			...
			<div className="container">
				<div className="main">
					...
					<div className="center">
						<div className="new-game-btn btn--new" onClick={this.handleNewGame}>
							{' '}
							🔄 NEW GAME{' '}
						</div>
						<div className="center-bottom">
							<div className="roll-btn btn--roll" onClick={this.handleDice}>
								{' '}
								🎲 ROOL DICE{' '}
							</div>
							<div className="hold-btn btn--hold" onClick={this.handleHold}>
								📥 Hold
							</div>
						</div>
					</div>
